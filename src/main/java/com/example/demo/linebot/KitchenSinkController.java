...
public class KitchenSinkController {
    ...
    public void handlePostbackEvent(PostbackEvent event) {
        ...
        */
        String param = event.getPostbackContent().getParams() == null ? "" : event.getPostbackContent().getParams().toString();
        this.replyText(replyToken, "Got postback data " + event.getPostbackContent().getData() + ", param " + param);
    }
